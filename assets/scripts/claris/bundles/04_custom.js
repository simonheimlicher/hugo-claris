/* File='scripts/claris/target/body/04_body_custom.js': hugo.Environment='{{ hugo.Environment }}' .Page='{{ .Page }}' .MediaType='{{ .MediaType }}' */
...
// Add your custom JavaScript code to this file
